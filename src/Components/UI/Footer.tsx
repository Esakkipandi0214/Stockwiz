...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="footer bg-base-200 text-base-content bg-gradient-to-r from-black to-blue-950  grid grid-cols-1 lg:pl-24 lg:pr-14 sm:grid-cols-1 p- lg:grid-cols-3 gap-5  mt-0">
