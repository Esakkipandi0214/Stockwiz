...
import Mobile1 from "../../../public/mob2.png";
import Mobile2 from "../../../public/mob1.png";
import Base from "../../../public/base.png";
import Image from "next/image";
import { motion } from "framer-motion";
import Typewriter from "typewriter-effect";
import { useEffect, useState } from "react";
import Phone1 from "../../../public/mobile1.png";
import Phone2 from "../../../public/mobile2.png";
    ...
    <div className="w-full p-4 md:p-12 lg:grid lg:gap-4 lg:grid-cols-12 grid-cols-1 bg-gradient-to-r from-black to-teal-900">
      ...
      <div className="min-h-[100px] md:row-span-3  md:col-span-7 md:flex hidden items-center justify-center text-center text-white">
        <div className="w-full md:ml-20 flex flex-col gap-2">
          <div className="relative md:-translate-x-16">
            <motion.div
              {...hangingAnimationLeft}
              className="relative md:ml-10 md:translate-y-8"
            >
              <Image src={Mobile1} width={340} height={200} alt="" />
              {/* <Image src={Phone1} width={300} height={200} alt="" /> */}
            </motion.div>
            <motion.div
              {...hangingAnimationRight}
              className="absolute md:top-1 md:right-44 md:-translate-y-11"
            >
              <Image src={Mobile2} width={380} height={400} alt="" />
              {/* <Image src={Phone2} width={400} height={400} alt="" /> */}
            </motion.div>
          </div>
          <Image
            src={Base}
            className="md:translate-y-3 md:-ml-20"
            width={650}
            height={500}
            alt=""
          />
      ...
      <div className=" min-h-[100px] md:col-span-5 md:ml-9 flex-col gap-10  md:flex-col md:gap-3 flex justify-start text-white">
        <div className="flex flex-col gap-1 lg:gap-2 text-center lg:text-left">
          <p className="text-lg">
            At Zentra Wealth, we turn your financial goals into real wealth. We
            use simple, smart strategies and offer personalized service to help
            you navigate the market and achieve the best results.
          </p>
        </div>
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <feGaussianBlur
                      stdDeviation="7.65"
                      result="effect1_foregroundBlur_5447_2309"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_5447_2309"
                    x1="41.5"
                    y1="14.5"
                    x2="13"
                    y2="41.5"
              ...
              >
                <g filter="url(#filter0_f_5447_2316)">
                  <circle
                    ...
                    cy="28"
                    r="12"
                    fill="url(#paint0_linear_5447_2316)"
                  />
                </g>
                <path
                  d="M25.375 24.3753V23.7344C25.375 23.4323 25.1302 23.1875 24.8281 23.1875C24.5261 23.1875 24.2812 23.4323 24.2812 23.7344V24.3753C23.6447 24.6011 23.1875 25.2089 23.1875 25.9219V28.9844C23.1875 29.6973 23.6447 30.3052 24.2812 30.5309V31.1719C24.2812 31.4739 24.5261 31.7188 24.8281 31.7188C25.1302 31.7188 25.375 31.4739 25.375 31.1719V30.5309C26.0115 30.3052 26.4688 29.6973 26.4688 28.9844V25.9219C26.4688 25.2089 26.0115 24.6011 25.375 24.3753ZM25.375 28.9844C25.375 29.2859 25.1297 29.5312 24.8281 29.5312C24.5266 29.5312 24.2812 29.2859 24.2812 28.9844V25.9219C24.2812 25.6203 24.5266 25.375 24.8281 25.375C25.1297 25.375 25.375 25.6203 25.375 25.9219V28.9844Z"
                  fill="white"
                />
                <path
                  d="M29.6406 26.5628V25.9219C29.6406 25.6198 29.3958 25.375 29.0938 25.375C28.7917 25.375 28.5469 25.6198 28.5469 25.9219V26.5628C27.9104 26.7886 27.4531 27.3964 27.4531 28.1094V30.0781C27.4531 30.7911 27.9104 31.3989 28.5469 31.6247V32.2656C28.5469 32.5677 28.7917 32.8125 29.0938 32.8125C29.3958 32.8125 29.6406 32.5677 29.6406 32.2656V31.6247C30.2771 31.3989 30.7344 30.7911 30.7344 30.0781V28.1094C30.7344 27.3964 30.2771 26.7886 29.6406 26.5628ZM29.6406 30.0781C29.6406 30.3797 29.3953 30.625 29.0938 30.625C28.7922 30.625 28.5469 30.3797 28.5469 30.0781V28.1094C28.5469 27.8078 28.7922 27.5625 29.0938 27.5625C29.3953 27.5625 29.6406 27.8078 29.6406 28.1094V30.0781Z"
                  fill="white"
                />
                <path
                  d="M33.9062 22.1878V21.5469C33.9062 21.2448 33.6614 21 33.3594 21C33.0573 21 32.8125 21.2448 32.8125 21.5469V22.1878C32.176 22.4136 31.7188 23.0214 31.7188 23.7344V27.8906C31.7188 28.6036 32.176 29.2114 32.8125 29.4372V30.0781C32.8125 30.3802 33.0573 30.625 33.3594 30.625C33.6614 30.625 33.9062 30.3802 33.9062 30.0781V29.4372C34.5428 29.2114 35 28.6036 35 27.8906V23.7344C35 23.0214 34.5428 22.4136 33.9062 22.1878ZM33.9062 27.8906C33.9062 28.1922 33.6609 28.4375 33.3594 28.4375C33.0578 28.4375 32.8125 28.1922 32.8125 27.8906V23.7344C32.8125 23.4328 33.0578 23.1875 33.3594 23.1875C33.6609 23.1875 33.9062 23.4328 33.9062 23.7344V27.8906Z"
                  fill="white"
                />
                <path
                  d="M34.4531 35H23.7344C22.2266 35 21 33.7734 21 32.2656V21.5469C21 21.2448 21.2448 21 21.5469 21C21.8489 21 22.0938 21.2448 22.0938 21.5469V32.2656C22.0938 33.1703 22.8297 33.9062 23.7344 33.9062H34.4531C34.7552 33.9062 35 34.1511 35 34.4531C35 34.7552 34.7552 35 34.4531 35Z"
                  fill="white"
                />
                <defs>
                  <filter
                    id="filter0_f_5447_2316"
                    x="0.7"
                    y="0.7"
                    width="54.6"
                    height="54.6"
                  ...
                  >
                    ...
                    <feGaussianBlur
                      stdDeviation="7.65"
                      result="effect1_foregroundBlur_5447_2316"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_5447_2316"
                    x1="41.5"
                    y1="14.5"
                    x2="19.5"
                    y2="40"
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <feGaussianBlur
                      stdDeviation="7.65"
                      result="effect1_foregroundBlur_5447_2327"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_5447_2327"
                    x1="41.5"
                    y1="14.5"
                    x2="19.5"
                    y2="40"
