...
const Testimonial: React.FC = () => {
  ...
  >
    ...
    <motion.span
      ...
      animate={controls}
      transition={{ duration: 0.6, ease: 'easeOut' }}
      className="bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent px-2 sm:px-4 md:px-6 text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-8xl font-semibold text-center"
    >
      Plans
    </motion.span>
  </motion.h4>
