        ...
        <div>
          <p className="text-base md:text-lg lg:text-xl text-white/70 font-normal">
            ...
            <ul className="list-disc grid gap-2 md:gap-3 pl-5 text-left text-white mt-3 mb-5">
              ...
              <li className="text-base md:text-lg lg:text-lg">Course available in English & Tamil language.</li>
            </ul>
            ...
            <Image 
              src="/ZW1.2.png" // Replace with your actual image path or import it
          ...
          <div className="relative flex justify-center lg:justify-start lg:mt-0 lg:w-full w-auto">
           <Image 
            src="/ZW1.png" // Replace with your actual image path or import it
             alt="Description of image"
              width={1000} // You can adjust the width and height as needed
                height={600}
                className="rounded-xl"/>
      ...
      content: (
        <div>
          <p className="text-base md:text-lg lg:text-lg text-white/70 font-normal">
            ...
            <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full  w-auto">
            <Image 
              src="/ZW2.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>  
          ...
          <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full w-auto">
          <Image 
              src="/ZW2.1.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>
          ...
          <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full w-auto">
          <Image 
              src="/ZW2.2.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>
        ...
        },
        {
          ...
          content: (
            ...
            <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full  w-auto">
            <Image 
              src="/ZW3.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>
          ...
          <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full w-auto">
          <Image 
              src="/ZW3.1.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>
          ...
          <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full  w-auto">
          <Image 
              src="/ZW3.2.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>
          ...
          <div className="relative flex justify-center lg:justify-start  lg:mt-0 lg:w-full w-auto">
          <Image 
              src="/ZW3.3.png" // Replace with your actual image path or import it
              alt="Description of image"
              width={1000} // You can adjust the width and height as needed
              height={600}
              className="rounded-xl"/>         
