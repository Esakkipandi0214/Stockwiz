...
const Testimonial: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-black to-blue-900  pr-6 pb-20">
...
<div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:justify-items-center bg-white/5 rounded-3xl py-16 my-20 mx-24 border border-slate-600/35 text-center lg:text-left text-white">
  ...
  {/* <!-- Card 1 --> */}
  <div className="max-w-sm bg-black border -translate-x-11 z-10 border-white/15 rounded-3xl shadow flex flex-col hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] items-center justify-evenly">
  ...
  {/* <!-- Card 2 --> */}
  <div className="max-w-sm bg-black border z-30 -translate-y-10 hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] border-white/15 rounded-3xl shadow flex flex-col items-center justify-evenly">
    <a href="#" className="p-4">
      <Image
        className="rounded-t-lg"
        src={Image3}
  ...
  {/* <!-- Card 3 --> */}
  <div className="max-w-sm bg-black border z-10 hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] border-white/15 rounded-3xl shadow flex flex-col items-center justify-evenly">
    <a href="#" className="p-4">
  ...
  {/* <!-- Card 4 --> */}
  <div className="max-w-sm bg-black border translate-x-7 z-30 hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] border-white/15 rounded-3xl shadow flex flex-col items-center justify-evenly">
    <a href="#" className="p-4">
      <Image
        className="rounded-t-lg"
        src={Image4}
  ...
  {/* <!-- Card 5 --> */}
  <div className="max-w-sm bg-black z-20 border translate-y-1/3 hover:border-white hover:shadow-[0_0_15px_rgba(255,255,255,0.6)] absolute border-white/15 rounded-3xl shadow flex flex-col items-center justify-evenly">
    <a href="#" className="p-4">
      <Image
        className="rounded-t-lg"
        src={Image2}
